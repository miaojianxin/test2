...
static const char *getMQRequestNameByCode(int iCode)
{
#define DECODE_REQ_NAME(_code) \
    case _code: \
        return #_code;

    switch(iCode)
    {
    DECODE_REQ_NAME(SEND_MESSAGE_VALUE);
    DECODE_REQ_NAME(PULL_MESSAGE_VALUE);
	DECODE_REQ_NAME(QUERY_MESSAGE_VALUE);
	DECODE_REQ_NAME(QUERY_BROKER_OFFSET_VALUE);
	DECODE_REQ_NAME(QUERY_CONSUMER_OFFSET_VALUE);
	DECODE_REQ_NAME(UPDATE_CONSUMER_OFFSET_VALUE);
	DECODE_REQ_NAME(UPDATE_AND_CREATE_TOPIC_VALUE);
	DECODE_REQ_NAME(GET_ALL_TOPIC_CONFIG_VALUE);
	DECODE_REQ_NAME(GET_TOPIC_CONFIG_LIST_VALUE);
	DECODE_REQ_NAME(GET_TOPIC_NAME_LIST_VALUE);
	DECODE_REQ_NAME(UPDATE_BROKER_CONFIG_VALUE);
	DECODE_REQ_NAME(GET_BROKER_CONFIG_VALUE);
	DECODE_REQ_NAME(TRIGGER_DELETE_FILES_VALUE);

    DECODE_REQ_NAME(GET_BROKER_RUNTIME_INFO_VALUE);
    DECODE_REQ_NAME(SEARCH_OFFSET_BY_TIMESTAMP_VALUE);
    DECODE_REQ_NAME(GET_MAX_OFFSET_VALUE);
    DECODE_REQ_NAME(GET_MIN_OFFSET_VALUE);
    DECODE_REQ_NAME(GET_EARLIEST_MSG_STORETIME_VALUE);
    DECODE_REQ_NAME(VIEW_MESSAGE_BY_ID_VALUE);
    DECODE_REQ_NAME(HEART_BEAT_VALUE);
    DECODE_REQ_NAME(UNREGISTER_CLIENT_VALUE);
    DECODE_REQ_NAME(CONSUMER_SEND_MSG_BACK_VALUE);
    DECODE_REQ_NAME(END_TRANSACTION_VALUE);
    DECODE_REQ_NAME(GET_CONSUMER_LIST_BY_GROUP_VALUE);
    DECODE_REQ_NAME(CHECK_TRANSACTION_STATE_VALUE);
    DECODE_REQ_NAME(NOTIFY_CONSUMER_IDS_CHANGED_VALUE);
    DECODE_REQ_NAME(LOCK_BATCH_MQ_VALUE);
    DECODE_REQ_NAME(UNLOCK_BATCH_MQ_VALUE);
    DECODE_REQ_NAME(GET_ALL_CONSUMER_OFFSET_VALUE);
	DECODE_REQ_NAME(GET_ALL_DELAY_OFFSET_VALUE);
    
    DECODE_REQ_NAME(PUT_KV_CONFIG_VALUE);
    DECODE_REQ_NAME(GET_KV_CONFIG_VALUE);
    DECODE_REQ_NAME(DELETE_KV_CONFIG_VALUE);
    DECODE_REQ_NAME(REGISTER_BROKER_VALUE);
    DECODE_REQ_NAME(UNREGISTER_BROKER_VALUE);
    DECODE_REQ_NAME(GET_ROUTEINTO_BY_TOPIC_VALUE);
    DECODE_REQ_NAME(GET_BROKER_CLUSTER_INFO_VALUE);
    DECODE_REQ_NAME(UPDATE_AND_CREATE_SUBSCRIPTIONGROUP_VALUE);
    DECODE_REQ_NAME(GET_ALL_SUBSCRIPTIONGROUP_CONFIG_VALUE);
    DECODE_REQ_NAME(GET_TOPIC_STATS_INFO_VALUE);
    DECODE_REQ_NAME(GET_CONSUMER_CONNECTION_LIST_VALUE);
    DECODE_REQ_NAME(GET_PRODUCER_CONNECTION_LIST_VALUE);
    DECODE_REQ_NAME(WIPE_WRITE_PERM_OF_BROKER_VALUE);
    DECODE_REQ_NAME(GET_ALL_TOPIC_LIST_FROM_NAMESERVER_VALUE);
    DECODE_REQ_NAME(DELETE_SUBSCRIPTIONGROUP_VALUE);
    DECODE_REQ_NAME(GET_CONSUME_STATS_VALUE);
    DECODE_REQ_NAME(SUSPEND_CONSUMER_VALUE);
    DECODE_REQ_NAME(RESUME_CONSUMER_VALUE);
    DECODE_REQ_NAME(RESET_CONSUMER_OFFSET_IN_CONSUMER_VALUE);

    DECODE_REQ_NAME(RESET_CONSUMER_OFFSET_IN_BROKER_VALUE);
    DECODE_REQ_NAME(ADJUST_CONSUMER_THREAD_POOL_VALUE);
    DECODE_REQ_NAME(WHO_CONSUME_THE_MESSAGE_VALUE);
    DECODE_REQ_NAME(DELETE_TOPIC_IN_BROKER_VALUE);
    DECODE_REQ_NAME(DELETE_TOPIC_IN_NAMESRV_VALUE);
    DECODE_REQ_NAME(GET_KV_CONFIG_BY_VALUE_VALUE);
    DECODE_REQ_NAME(DELETE_KV_CONFIG_BY_VALUE_VALUE);
    DECODE_REQ_NAME(GET_KVLIST_BY_NAMESPACE_VALUE);
